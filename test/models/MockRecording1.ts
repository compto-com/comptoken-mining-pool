...
export class MockRecording1 {
    ...
    public static MINING_AUTHORIZE = `{"id": 3, "method": "mining.authorize", "params": ["DmnsCLPv6UtiUJQCNjtPA6UXyNHecPk6YUFopcRBKbY.bitaxe3", "x"]}\n`;
    ...
    public static MINING_SUBMIT = `{"id": 5, "method": "mining.submit", "params": ["DmnsCLPv6UtiUJQCNjtPA6UXyNHecPk6YUFopcRBKbY.bitaxe3", "2", "c7080000", "64b3f3ec", "ed460d91", "00002000"]}\n`;
}
